...
test.describe('Rejestracja - formularz szczegółowy', () => {
  ...
  test('Powinno wyświetlić formularz szczegółowy z danymi wpisanymi wcześniej', async ({ page, accountInfoReadyUser }) => {
  ...
  test('Rejestracja użytkownika - pełny formularz', async ({ page, accountInfoReadyUser}) => {
...
test('Walidacja - pusty password', async ({ page, accountInfoReadyUser }) => {
  await accountInfoPage.clickCreateButton();
...
test('Walidacja - bez podania daty urodzin @bug', async ({ page, accountInfoReadyUser })=>{
await accountInfoPage.fillAddressInformation(user)
...
test('Walidacja - bez podania płci @bug', async ({ page, accountInfoReadyUser })=>{
await accountInfoPage.fillAddressInformation(user)
await accountInfoPage.fillPassword(user)
...
test('Walidacja - bez podania First Name', async ({ page, accountInfoReadyUser })=>{
 await accountInfoPage.fillAccountInformation(user);
    await accountInfoPage.fillAddressInformation(user);
...
test('Walidacja - bez podania State', async ({ page, accountInfoReadyUser })=>{
 await accountInfoPage.fillAccountInformation(user);
    await accountInfoPage.fillAddressInformation(user);
...
test('Walidacja - bez podania City', async ({ page, accountInfoReadyUser })=>{
 await accountInfoPage.fillAccountInformation(user);
    await accountInfoPage.fillAddressInformation(user);
...
test('Walidacja - bez podania Zipcode', async ({ page, accountInfoReadyUser })=>{
 await accountInfoPage.fillAccountInformation(user);
    await accountInfoPage.fillAddressInformation(user);
...
test('Walidacja - bez podania Mobile Number', async ({ page, accountInfoReadyUser })=>{
 await accountInfoPage.fillAccountInformation(user);
    await accountInfoPage.fillAddressInformation(user);
...
test('Walidacja - usunięcie Name', async ({ page, accountInfoReadyUser })=>{
 await accountInfoPage.fillAccountInformation(user);
    await accountInfoPage.fillAddressInformation(user);
...
test('Email nie może być zmieniony', async ({ page, accountInfoReadyUser })=>{
