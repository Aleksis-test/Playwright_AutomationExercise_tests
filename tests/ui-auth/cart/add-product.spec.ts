...
test("Dodawanie produktu z widoku strony głównej", async ({ page }) => {
...
test("Dodawanie produktu z widoku strony głównej i kontynuacja zakupów", async ({ page }) => {
...
test("Dodanie produktu z ilością 2 z widoku szczegółów produktu", async ({ page }) => {
...
test("Dodawanie produktu z podstrony produktów", async ({ page }) => {
...
test("Dodawanie produktu z widoku produktu", async ({ page }) => {
